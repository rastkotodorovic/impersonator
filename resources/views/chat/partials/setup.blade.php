<div class="mx-auto max-w-lg">
    <div class="text-center">
        ...
        <h3 class="mt-4 text-lg font-medium text-gray-900">Connect to OpenAI</h3>
        <p class="mt-2 text-sm text-gray-500">
            Enter your API key or sign in with your OpenAI account to start chatting.
        </p>
    </div>
    ...
    <div class="mt-8 space-y-6">
        ...
        <div class="rounded-lg border border-gray-200 p-6">
            ...
            <p class="mt-1 text-xs text-gray-500">Use your own OpenAI API key. You can find it at platform.openai.com.</p>
